...
# !!! Main.UserApp is configured as an alias for Main.CommerceBrain and you might encounter it in some tests
using Main.CommerceBrain, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "CommerceBrain tests" begin
  @includetests ARGS
end
